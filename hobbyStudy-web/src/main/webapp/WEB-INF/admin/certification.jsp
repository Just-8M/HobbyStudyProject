...
<body>
	<c:choose>
		<c:when test="${certificationSearchResult == 'failLogin'}">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="${pageContext.request.contextPath}/adminController/certification">用户管理</a></li>
            <li class="active">学籍认证</li>
        </ol>
        <!-- /路径导航 -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-offset-2 col-sm-2 control-label">学籍证明</label>
                                    <div class="col-sm-6">
                                       <img src="${pageContext.request.contextPath}/admin//images/logo/black_logo_light.png" id="certificationPic">
                                    </div>
                                </div>
                            </form>
                        </div>
