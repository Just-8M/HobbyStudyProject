...
<head>
    ...
    <style>
        ...
        /* 设置模态框身份证图片的大小 */
        .modal-dialog .modal-body .form-group #IdCard-front,
        .modal-dialog .modal-body .form-group #IdCard-reverse
        {
            width: 100%;
            height: 150px;
        }
...
<body>
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="${pageContext.request.contextPath}/adminController/realname">用户管理</a></li>
        ...
        <section class="content-header">
            ...
            <div class="btn-group rt" role="group">
                ...
                <button type="button" class="btn btn-default" title="审核未通过">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">{{用户ID}}</h4>
                        </div>
                        <div class="modal-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-offset-2 col-sm-2 control-label">用户ID</label>
                                    <div class="col-sm-6">
                                        <p id="userId" class="form-control-static">{{用户ID}}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-offset-2 col-sm-2 control-label">真实姓名</label>
                                    <div class="col-sm-6">
                                        <p id="realname" class="form-control-static">真实姓名</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-offset-2 col-sm-2 control-label">身份证号码</label>
                                    <div class="col-sm-6">
                                        <p id="IdcardNum" class="form-control-static">XXXXXXXXXXXXXXXXXXX</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-offset-2 col-sm-2 control-label">身份证正面</label>
                                    <div class="col-sm-6">
                                        <img src="./images/logo/black_logo_light.png" id="IdCard-front">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-offset-2 col-sm-2 control-label">身份证反面</label>
                                    <div class="col-sm-6">
                                        <img src="${pageContext.request.contextPath}/admin//images/logo/black_logo_light.png" id="IdCard-reverse">
                                    </div>
                                </div>
                            </form>
                        </div>
