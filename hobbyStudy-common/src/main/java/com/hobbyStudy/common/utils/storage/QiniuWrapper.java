package com.hobbyStudy.common.utils.storage;
...
import com.hobbyStudy.common.utils.PropertiesUtil;
...
public class QiniuWrapper {
	...
	static{
		...
		Configuration cfg = new Configuration(Zone.zone1());//设置空间上传域名(为华北地区)
