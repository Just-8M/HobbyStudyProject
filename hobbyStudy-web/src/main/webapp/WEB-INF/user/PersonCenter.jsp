...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/lib/iconmoon/personCenter/style.css">
</head>
                    ...
                    <div class="right_item_body">
                        ...
                        <form class="form-horizontal" id="infoFrom">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" id="userId" type="text" placeholder="${PersonCenterDetaild.userid}"
                                        disabled> </div>
                            </div>
                            <!--用户昵称  -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="userName" placeholder="{{随机名字}}">
                                </div>
                            </div>
                            <!-- 性别 -->
                            <div class="form-group">
                    ...
                    <div class="right_item_body">
                        ...
                        <div class="media">
                            ...
                            <div class="media-right">
                                <button class="btn btn-default" data-toggle="modal" data-target="#EmailModal">立即绑定/更改</button>
                            </div>
                        </div>
                                        ...
                                        <form class="form-horizontal" id="emailForm">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="sendBtn" id="countdown">
                                                        发送验证码
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img class="media-object" src="${pageContext.request.contextPath}/images/iconfont/phone.png" alt="...">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="modal fade" id="passwordModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a href="forgetPassword.html" class="col-sm-3 forgetPsw" style="text-align:left">忘记密码？</a>
                                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                                        <button type="submit" class="btn btn-primary">确定</button>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="authenticIdCard"
                                                        placeholder="请输入您的身份证号码" maxlength="18">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="authenticIdPhoto" class="col-sm-3 control-label">身份证照片</label>
                                                <div class="col-sm-4">
                                                    <input type="file" class="form-control upload_IdPhoto" id="authenticIdPhoto_front">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="file" class="form-control upload_IdPhoto" id="authenticIdPhoto_reverse">
                    ...
                    <div class="right_item_body">
                        <form class="form-horizontal col-sm-8 certificForm" id="certificForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="schoolName" placeholder="请输入院校名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="enterTime" class="col-sm-2 control-label">入学时间</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="enterTime" placeholder="请输入您的入学时间，如2015">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select name="degree" id="degree" class="form-control">
                                        <option value="specialized">专科</option>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.photo_front').click(function () {
                $('#authenticIdPhoto_front').click();
            })
            $('.photo_reverse').click(function () {
                $('#authenticIdPhoto_reverse').click();
            })
