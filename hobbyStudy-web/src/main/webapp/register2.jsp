...
<script type="text/javascript" src="script/bootstrap/jquery-1.8.0.min.js"></script>
...
<body>
<form action="${pageContext.request.contextPath}/MailVerify" id="RegistForm"    method="post">
